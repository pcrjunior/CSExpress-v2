    ...
    <body>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        {{ \Carbon\Carbon::parse($d['data'])->format('d/m/y') }}
                    </td>
                    <td>
                        {{ $d['cliente'] }}
                    </td>
                    ...
                    <td class="text-end">
                        R$ {{ number_format($d['carro'],2,',','.') }}
                    </td>

                    <td class="text-end">
                        R$ {{ number_format($d['ajudantes'],2,',','.') }}
                    </td>
                ...
                <tr class="total">
                    ...
                    <td class="text-end">
                        R$ {{ number_format($totalCarro,2,',','.') }}
                    </td>
                    <td class="text-end">
                        R$ {{ number_format($totalAjudantes,2,',','.') }}
                    </td>
                </tr>

...
@section('title', 'Adicionar Filial')
            ...
            <div class="card bg-light shadow-sm">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <h4 class="mb-0 text-primary">
                        <i class="fas fa-building me-2"></i>Cadastro de Empresa
                    </h4>
                    ...
                    <form action="{{ route('filiais.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="empresa_cnpj" class="form-control" value="{{ $empresa->cnpj }}" disabled>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="estado" id="estado" class="form-control" value="{{ old('estado') }}" maxlength="2" required>
                            </div>
                        </div>
